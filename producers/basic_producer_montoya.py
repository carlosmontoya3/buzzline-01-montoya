...
ADJECTIVES: list = ["cheerful", "tiring", "heavy", "fun", "interesting"]
ACTIONS: list = ["sang", "ran", "lifted", "threw", "read"]
TOPICS: list = ["a song", "a race", "a couch", "a baseball", "a book"]
...
def generate_messages():
    ...
    while True:
        ...
        yield f"After school, I {action} {topic}! It was {adjective}!"
